...
<body>
  ...
  <section class="book_section">
    ...
    <div class="img-box">
      <img src="{{asset('assets/images/book-car.png')}}" alt="">
    </div>
  </section>
  ...
  <section class="car_section layout_padding2-top layout_padding-bottom">
    <div class="container">
      <div class="heading_container">
        ...
        <p>
        We provide a variety of cars that will definitely interest you
        </p>
      </div>
  ...
  <section class="rent_section layout_padding">
    <div class="container">
      <div class="rent_container">
        <div class="box">
          <div class="img-box">
            <img src="{{asset('assets/images/r-1.png')}}" alt="">
          </div>
          <div class="price">
            <a href="">
              Rent $200
        ...
        <div class="box">
          <div class="img-box">
            <img src="{{asset('assets/images/r-3.png')}}" alt="">
          </div>
          <div class="price">
            <a href="">
              Rent $200
        ...
        <div class="box">
          <div class="img-box">
            <img src="{{asset('assets/images/r-4.png')}}" alt="">
          </div>
          <div class="price">
            <a href="">
              Rent $200
        ...
        <div class="box">
          <div class="img-box">
            <img src="{{asset('assets/images/r-5.png')}}" alt="">
          </div>
          <div class="price">
            <a href="">
              Rent $200
        ...
        <div class="box">
          <div class="img-box">
            <img src="{{asset('assets/images/r-6.png')}}" alt="">
          </div>
          <div class="price">
            <a href="">
              Rent $200
          ...
          <div class="owl-carousel">
            <div class="item">
              <div class="box">
                ...
                <div class="img-box">
                  <img src="{{asset('assets/images/b-1.jpg')}}" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                    Vintage
            ...
            <div class="item">
              <div class="box">
                ...
                <div class="img-box">
                  <img src="{{asset('assets/images/b-2.jpg')}}" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                    Steering wheels
            ...
            <div class="item">
              <div class="box">
                ...
                <div class="img-box">
                  <img src="{{asset('assets/images/b-3.jpg')}}" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                    Buick Car
              ...
              <div class="box">
                ...
                <div class="client_id">
                  <div class="img-box">
                    ...
                    <img src="{{asset('assets/images/client-1-white.png')}}" alt="" class="img-2">
                  </div>
                  <div class="name">
                    <h6>
                      Established
              ...
              <div class="box">
                ...
                <div class="client_id">
                  <div class="img-box">
                    ...
                    <img src="{{asset('assets/images/client-2-white.png')}}" alt="" class="img-2">
                  </div>
                  <div class="name">
                    <h6>
                      Blished
